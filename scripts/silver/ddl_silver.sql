...
-------------------------------------------------------------------------------------
 ...
 source systems. These tables contain cleaned and standardized data from the bronze layer 
 and serve as the foundation for transformations into the gold layer.
